...
DROP TRIGGER IF EXISTS "set_public_request_logs_updated_at" ON "public"."request_logs";
...
DROP TRIGGER IF EXISTS "set_public_request_event_logs_updated_at" ON "public"."request_event_logs";
...
ALTER TABLE "public"."request_event_logs"

...
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER "set_public_members_credentials_updated_at"
BEFORE UPDATE ON "public"."members_credentials"
FOR EACH ROW
EXECUTE PROCEDURE "public"."set_current_timestamp_updated_at"();
COMMENT ON TRIGGER "set_public_members_credentials_updated_at" ON "public"."members_credentials"

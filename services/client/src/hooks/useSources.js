...
const genSourceSchemasMutation = `
  mutation ($datasource_id: uuid!, $branch_id: uuid!, $tables: [SourceTable!]!, $overwrite: Boolean, $format: String) {
    gen_dataschemas(datasource_id: $datasource_id, branch_id: $branch_id, tables: $tables, overwrite: $overwrite, format: $format) {
      code
      message
    }
  }
